...
from isotropy.models import IBert, IBertConfig, IRoberta, IRobertaConfig
from isotropy.trainers import ITrainer, GenerateEmbeddingCallback
from isotropy.utils import (
...
def main():
    ...
    if model_args.loss_fn_settings:
        config_kwargs['loss_fn_settings'] = model_args.loss_fn_settings
    if model_args.loss_param_settings:
        config_kwargs['loss_param_settings'] = model_args.loss_param_settings
    if model_args.mt_size:
        config_kwargs['mt_size'] = model_args.mt_size
    ...
    config_class = IBertConfig if model_args.model_type == 'bert' else IRobertaConfig
    ...
    model_type = IBert if model_args.model_type == 'bert' else IRoberta
